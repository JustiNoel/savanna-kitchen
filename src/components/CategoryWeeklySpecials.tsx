...
interface CategoryWeeklySpecialsProps {
  category: 'food' | 'grocery' | 'shop' | 'spirits';
}

const CategoryWeeklySpecials = ({ category }: CategoryWeeklySpecialsProps) => {
  ...
  const fetchSpecials = async () => {
    ...
    // For food category, fetch from weekly_specials table which links to menu_items
    // For other categories, we'd need to extend the system - for now, only food has specials
    if (category === 'food') {
    ...
    // Future: Add support for grocery_specials, shop_specials, spirits_specials tables
  };
...
export default CategoryWeeklySpecials;
